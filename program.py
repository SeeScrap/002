...
schedule.every().hours.do(transfer_data)

async def program1():
    schedule.every(60).minutes.do(weather_report.append_temp_to_json)
    schedule.every().day.at("06:00").do(watering1, ser) #รดน้ำตอนเช้า
    schedule.every().day.at("18:00").do(watering1, ser) #รดน้ำตอนเย็น
...
async def program2():
    ...
    schedule.every().day.at("06:00").do(watering1, ser) #รดน้ำตอนเช้า
    schedule.every().day.at("18:00").do(watering1, ser) #รดน้ำตอนเย็น
    schedule.every().day.at("06:00").do(watering1_stop, ser)
    schedule.every().day.at("18:00").do(watering1_stop, ser)
    schedule.every().day.at("23:59").do(weather_report.calculate_and_log_average)
...
async def program3():
    schedule.every(60).minutes.do(weather_report.append_temp_to_json)
    schedule.every().day.at("07:00").do(watering2, ser) #รดน้ำตอนเช้า
    schedule.every().day.at("19:00").do(watering2, ser) #รดน้ำตอนเย็น
    schedule.every().day.at("06:00").do(watering2_stop, ser)
    schedule.every().day.at("18:00").do(watering2_stop, ser)
    schedule.every().day.at("23:59").do(weather_report.calculate_and_log_average)
...
async def program4():
    schedule.every(60).minutes.do(weather_report.append_temp_to_json)
    schedule.every().day.at("07:00").do(watering2, ser) #รดน้ำตอนเช้า
    schedule.every().day.at("17:00").do(watering2, ser) #รดน้ำตอนเย็น
    schedule.every().day.at("06:00").do(watering2_stop, ser)
    schedule.every().day.at("18:00").do(watering2_stop, ser)
    schedule.every().day.at("23:59").do(weather_report.calculate_and_log_average)
