...
from weather_report import append_temp_to_json, calculate_and_log_average
...
schedule.every(15).minutes.do(append_temp_to_json)
schedule.every().day.at("07:00").do(watering, ser)
schedule.every().day.at("18:00").do(watering, ser)
schedule.every().day.at("23:59").do(calculate_and_log_average)
